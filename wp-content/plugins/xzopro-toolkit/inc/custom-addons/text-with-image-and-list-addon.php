...
vc_map(
    array(
        "name" => __( "Text With Image And List", "xzopro-toolkit" ),
        "base" => "xzopro_text_with_image_and_list",
        ...
        "params" => array(
            ...
            array(
                ...
                "param_name" => "twial_img",
                "description" => __( "Upload image", "xzopro-toolkit" ),
            ),

            array(
                "type" => "textfield",
                "heading" => __( "Title", "xzopro-toolkit" ),
                "param_name" => "twial_title",
                "holder" => "div",
