<?php
/*
Xzopro project Post Single Layout
*/
...
} elseif(array_key_exists('banner_text_align', $banner_meta) && $banner_meta['banner_text_align'] == '1') {
    $banner_default_text_align = xzopro_option('banner_default_text_align');
    $banner_text_align = $banner_default_text_align;
}else{
